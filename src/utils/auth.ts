...
export const generateToken = (payload: any): string => jwt.sign(payload, SECRET_KEY, { expiresIn: '30d' })
export const validateToken = (token: string): any => jwt.verify(token, SECRET_KEY)
